...
| employee_id:Dbl | first_name:Str | last_name:Str | email:Str | phone_number:Str | hire_date:Date | job_id:Str | salary:Dbl | commission_pct:Dbl | manager_id...10:Dbl | department_id...11:Dbl | department_id...12:Dbl | department_name:Str | manager_id...14:Dbl | location_id:Dbl |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
