...
| employee_id...1:Dbl | start_date:Date | end_date:Date | job_id...4:Str | department_id...5:Dbl | employee_id...6:Dbl | first_name:Str | last_name:Str | email:Str | phone_number:Str | hire_date:Date | job_id...12:Str | salary:Dbl | commission_pct:Dbl | manager_id:Dbl | department_id...16:Dbl |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
