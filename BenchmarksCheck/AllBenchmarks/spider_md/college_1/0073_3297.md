...
| stu_fname:Str | stu_lname:Str | crs_description:Str |
|---|---|---|
| William | Bowser | Accounting I |
| Anne | Smithson | Accounting I |
| William | Bowser | Intro. to Microcomputing |
| Anne | Smithson | Intro. to Microcomputing |
| William | Bowser | Intro. to Statistics |
| Anne | Smithson | Intro. to Statistics |
