...
| emp_fname:Str | crs_description:Str |
|---|---|
| Arnelle | Accounting I |
| Arnelle | Accounting I |
| Robert | Accounting I |
| Ismael | Accounting II |
| Ismael | Accounting II |
| Carlos | Intro. to Microcomputing |
| Gerald | Intro. to Microcomputing |
| Carlos | Intro. to Microcomputing |
| Peter | Database Design and Implementation |
| Gerald | Intro. to Statistics |
| Gerald | Intro. to Statistics |
| Peter | Statistical Applications |
| Peter | Statistical Applications |
