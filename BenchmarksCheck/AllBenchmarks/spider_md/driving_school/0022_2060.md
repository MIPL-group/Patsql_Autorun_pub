...
| customer_status_code:Str | cell_mobile_phone_number:Str | email_address:Str |
|---|---|---|
| Bad Customer | 848-099-2095x785 | mayert.judy@example.com |
| Good Customer | 577-584-4864 | karina.carroll@example.net |
